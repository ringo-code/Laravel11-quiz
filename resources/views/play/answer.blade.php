            ...
            <div class="lg:w-2/3 w-full mx-auto overflow-auto">
                <table class="table-auto w-full text-left whitespace-no-wrap">
                    <thead>
                        ...
                        <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">あなたの回答</th>
                    ...
                    <tbody>
                        @for ($i = 0; $i < 4; $i++)
                            <tr>
                                ...
                                <td class="px-4 py-3">
                                    {{ $quizOptions[$i]['is_correct'] === 1 ? '○' : '✖️' }}
                                </td>
                                <td class="px-4 py-3">
                                    {{ in_array($quizOptions[$i]['id'], $selectedOptions) ? '○' : '✖️' }}
                                </td>
                            </tr>
                        @endfor
                    </tbody>
