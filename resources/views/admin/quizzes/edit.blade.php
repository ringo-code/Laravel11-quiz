    ...
    <section class="text-gray-600 body-font relative">
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                {{-- フォーム --}}
                <form action="{{ route('admin.categories.quizzes.update', ['categoryId' => $category->id, 'quizId' => $quiz->id]) }}" method="POST" class="flex flex-wrap -m-2">
                    @csrf
                    <div class="p-2 w-full">
                        <div class="relative">
                            ...
                            >{{ old('question') ? old('question') : $quiz->question }}</textarea>
                        </div>
                    ...
                    <div class="p-2 w-full">
                        <div class="relative">
                            ...
                            >{{ old('explanation') ? old('explanation') : $quiz->explanation }}</textarea>
                        </div>
